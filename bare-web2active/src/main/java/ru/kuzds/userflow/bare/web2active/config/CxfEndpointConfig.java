package ru.kuzds.userflow.bare.web2active.config;
...
import ru.kuzds.userflow.bare.web2active.endpoint.EmployeeService;
import ru.kuzds.userflow.bare.web2active.endpoint.UserEndpoint;
